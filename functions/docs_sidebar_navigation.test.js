...
import docsSidebarNavigation from "./docs_sidebar_navigation.js";
...
test("builds weighted sidebar sections from generated documentation pages", () => {
  const pages = [
    ...
    { permalink: "/docs/guide/index.md", template: "veta/docs-raw", title: "Ignored" },
  ];
...
function docsPage(permalink, title, weight, icon = "", content = "# Content") {
  return { content, icon, permalink, template: "veta/docs", title, weight };
}
